...
# Например, из Москвы в Лондон — по понедельникам и средам в 10:00, а из Лондона в Париж — 10-го и 20-го числа
# каждого месяца в 15:30. Хотя бы между одной парой городов не должно быть сообщения.
import re
